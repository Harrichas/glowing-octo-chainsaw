...
function renderJournal2(newAddArr) {
  ...
  for (var i = 0; i < newAddArr.length; ++i) {
    ...
    $(`#row${i}`).html(`<td class="journalTable"><p class=placeAdded>${newAddArr[i].placeName} - ${newAddArr[i].date}
  <button class="" style="float:right"><i class="delBtn fas fa-trash-alt"></i></button>
  <button class="" style="float:right"><i class="picBtn fas fa-camera"></i></button></p>
...
function handleDeletePlace(event) {
  ...
  // const delSelected = $(this).parent(".journalRow").data();
  // const delSelected = $(this).parent(".journalTable").data();
  // const delSelected = $(this).parent(".placeAdded").data();
  const delSelected = $(this).data();
    // const delSelected = $(this).parent(".journalRow").data();

  console.log("under handleDelete delSelected = " + delSelected);
  // console.log("under handleDelete delSelected[0] = " + delSelected[0]);
  // console.log("under handleDelete delSelected[1] = " + delSelected[1]);
  // console.log("under handleDelete delSelected[2] = " + delSelected[2]);
...
$(document).ready(function () {
  ...
  $(document).on("click", ".delBtn", handleDeletePlace);
