  ...
  return (
    <div className="row d-flex justify-content-center">
        <div className="col-md-4 col-offset-md-4 col-xs-12 mt-5">
            <a className="btn btn-lg btn-google btn-block btn-outline border rounded bg-white" href={(process.env.REACT_APP_URL && `${process.env.REACT_APP_URL}/google`) || "http://localhost:3001/google"}>
