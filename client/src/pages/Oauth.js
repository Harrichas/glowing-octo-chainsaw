  ...
  return (
    <div className="row d-flex justify-content-center">
        <div class="col-md-4 col-offset-md-4 col-xs-12 mt-5">
            <a class="btn btn-lg btn-google btn-block btn-outline border rounded" href={process.env.REACT_APP_URL && `${process.env.REACT_APP_URL}/google` || "http://localhost:3001/google"}>
